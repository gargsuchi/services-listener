...
//    $url = \Drupal::config('twitter.settings')->get('twitter_api') . '/oauth/request_token';
//    try {
//      $params = array('oauth_callback' => _url('twitter/oauth', array('absolute' => TRUE)));
//
//      $response = $this->auth_request($url, $params);
//    }
//    catch (TwitterException $e) {
//      \Drupal::logger('twitter')->error('!message', array('!message' => $e->__toString()));
//      return FALSE;
//    }
...
//    $url = \Drupal::config('twitter.settings')->get('twitter_api') . '/oauth/authorize';
...
//
//    $url = \Drupal::config('twitter.settings')->get('twitter_api') . '/oauth/authenticate';
//    $url .= '?oauth_token=' . $token['oauth_token'];
//
//    return $url;
//  }
...
//
//    $url = \Drupal::config('twitter.settings')->get('twitter_api') . '/oauth/access_token';
//
...
//   */
//  protected function doRequest($url, $headers = array(), $method, $data) {
//    if ($method == "POST") {
//      $request = Drupal::httpClient()->post($url, array('data' => $data));
//    }
//    else {
...
//    }
//    return $response; //drupal_http_request($url, array('headers' => $headers, 'method' => $method, 'data' => $data));
//
//  }
//
...
//    $url = \Drupal::config('twitter.settings')->get('twitter_api') . '/1.1/' . $path . $format;
//    return $url;
//  }
//
//  /********************************************/
...
//   */
//  public function account_settings($params) {
